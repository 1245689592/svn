...
public class MYDatePrinter implements DatePrinter, Serializable {
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Constructs a new MYDatePrinter.</p>
     *
     ...
     */
    protected MYDatePrinter(final String pattern, final TimeZone timeZone, final Locale locale) {
        mPattern = pattern;
        mTimeZone = timeZone;
        mLocale = locale;
    ...
    protected List<Rule> parsePattern() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            case 'y': // year (number)
                ...
                break;
            case 'J':
            	rule=SeasonField.INSTANCE;
            	break;
            case 'B':
            	rule=HalfYearField.INSTANCE;
            	break;
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof MYDatePrinter == false) {
            return false;
        }
        final MYDatePrinter other = (MYDatePrinter) obj;
    ...
    public String toString() {
        return "MYDatePrinter[" + mPattern + "," + mLocale + "," + mTimeZone.getID() + "]";
    }
    ...
    private static class SeasonField implements NumberRule{
    	static final SeasonField INSTANCE = new SeasonField();
		...
		public void appendTo(StringBuffer buffer, Calendar calendar) {
			appendTo(buffer,calendar.get(Calendar.MONTH)/3+1);
		}
    ...
    private static class HalfYearField implements NumberRule{
    	static final HalfYearField INSTANCE = new HalfYearField();
    	
		public HalfYearField() {
			super();
		}
		...
		@Override
		public void appendTo(StringBuffer buffer, Calendar calendar) {
			appendTo(buffer,calendar.get(Calendar.MONTH)<6?0:1);
		}
