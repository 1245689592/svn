...
public class ByteUtils {
	 ...
	 * @return 例如，2015-11-22 13:55:46 会返回 {0x0f,0x0b,0x16,0x0d,0x37,0x2e}
	 */
...
//		return result;
	...
	public static void main(String[] args) {
		System.out.println(intToDouble(10034, 10, 1000));
		System.out.println(DoubleToInt(3.4,10,1000));
	}
	/**
	 * 
	 * @param a
